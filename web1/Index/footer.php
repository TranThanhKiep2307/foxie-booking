	...
	<div class="container-fluid pt-lg-5">
		<div class="row">
			<div class="col-lg-3 col-sm-6 mb-lg-0 mb-5 footer-grid-agileits-w3ls1 text-left">
				<h3 class="mb-sm-5 mb-4 mt-sm-0 mt-4">Về ứng dụng của chúng tôi</h3>	
				<p>Trang web của chúng tôi sẽ cung cấp cho bạn những chuyến bay an toàn và chất lượng nhất</p>
				<a href="#" class="read">Xem thêm <i class="fas fa-caret-right"></i></a>
			</div>
			<div class="col-lg-3 col-sm-6 mb-lg-0 mb-5 footer-grid-agileits-w3ls1 text-left">
				<h3 class="mb-sm-5 mb-4">Thông tin của chúng tôi</h3>	
				<ul class="w3ls-footer-bottom-list">
					<li> <span class="fas fa-map-marker"></span> Phát triển ứng dụng website<span> Cần Thơ </span></li>
					<li> <span class="fas fa-envelope"></span> <a href="mailto:nhom08@student.ctu.edu.vn"> nhom08@student.ctu.edu.vn</a> </li>
					<li> <span class="fas fa-phone"></span> +0123 456 789 </li>
					<li> <span class="fas fa-fax"></span> +0123 456 789 </li>
					<li> <span class="fas fa-globe"></span> <a href="#"> www.foxiebooking.com</a> </li>
				</ul>
			</div>
			<div class="col-lg-3 col-sm-6 mb-sm-0 mb-5 footer-grid-agileits-w3ls text-left">
				<div class="tech-btm">
					<h3 class="mb-sm-5 mb-4">Tin mới nhất</h3>
					<div class="blog-grids row mb-3">
						...
						<div class="col-8 blog-grid-right">
							...
							<div class="sub-meta">
								<span>
									<i class="far fa-clock"></i> 01/04/2023</span>
							</div>
						</div>
					...
					<div class="blog-grids row mb-3">
						...
						<div class="col-8 blog-grid-right">
							...
							<div class="sub-meta">
								<span>
									<i class="far fa-clock"></i> 02/04/2023</span>
							</div>
						</div>
					...
					<div class="blog-grids row">
						...
						<div class="col-8 blog-grid-right">
							...
							<h5>
								<a href="#">Vân chuyển hàng hóa </a>
							</h5>
							<div class="sub-meta">
								<span>
									<i class="far fa-clock"></i> 03/04/2023</span>
							</div>
						</div>
			...
			<div class="col-lg-3 col-sm-6 subscribe-main footer-grid-agileits-w3ls text-left">
				<h3 class="mb-sm-5 mb-4">Thắc mắc</h3>
				...
				<h3 class="mb-sm-5 mb-4">Liên hệ với chúng tôi qua</h3>
					<ul>
						<li class="mr-1">
		...
		<div class="footer-cpy text-center pt-sm-5 mt-sm-5 mt-4 pt-3">
			<div class="w3layouts-agile-copyrightbottom">
				<p>© 2023 Foixe Booking | Thiết kế bởi
					<a href="#">Nhom8</a>
				</p>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="#" method="post">
					...
					<p class="text-center dont-do text-white mt-3">Bạn chưa có tài khoản?
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="#" method="post">
					...
					<div class="form-group">
						<label for="password2" class="col-form-label">Xác nhận lại mật khẩu</label>
